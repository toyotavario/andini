...
link1_status=$(curl -Is https://www.dropbox.com/s/c2qfhk27cah3rxf/Windows_Server_2012_virtio_082284640547.iso?dl=0 | grep HTTP | cut -f2 -d" " | head -1)
link2_status=$(curl -Is https://www.dropbox.com/s/c2qfhk27cah3rxf/Windows_Server_2012_virtio_082284640547.iso?dl=0 | grep HTTP | cut -f2 -d" ")
...
if [ $link1_status = "200" ] ; then 
	sudo wget -O /mediabots/WS2012R2.ISO https://www.dropbox.com/s/c2qfhk27cah3rxf/Windows_Server_2012_virtio_082284640547.iso?dl=0 
elif [ $link2_status = "200" -o $link2_status = "301" -o $link2_status = "302" ] ; then 
	sudo wget -P /mediabots https://www.dropbox.com/s/c2qfhk27cah3rxf/Windows_Server_2012_virtio_082284640547.iso?dl=0
else
